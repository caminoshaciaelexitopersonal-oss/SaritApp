...
async def create_tactical_plan(state: FormacionDeportivaColonelState) -> FormacionDeportivaColonelState:
...
def get_formacion_deportiva_colonel_graph():
    ...
    return workflow.compile().with_types(input_type=FormacionDeportivaColonelState)
