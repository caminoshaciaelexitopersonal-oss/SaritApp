...
def almacenista_gestion_elementos(page: ft.Page, tenant_id: int, user_id: int):

    # --- Instantiate the Assistant ---
    # Almacenista is not tied to a specific area, so let them choose.
    ...
    return ft.View(
        "/almacenista/elementos",
        [
            ft.AppBar(title=ft.Text("Gestión de Elementos de Inventario")),
            ft.Container(
                padding=20,
                expand=True,
                content=ft.Column([
